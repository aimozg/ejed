...
class XmlExplorer(input: XMLEventReader): XmlExplorerController() {
	...
	constructor(input: String) : this(
			XMLInputFactory.newFactory().createXMLEventReader(input.reader())
	)
	...
	override fun error(msg: String): Nothing {
		...
		if (e == null) kotlin.error(msg)
			...
			throw XmlExplorerException(e.lineNumber, e.columnNumber, msg)
		}
	}
	
	class XmlExplorerException(val lineNumber: Int,
	                           val columnNumber: Int,
	                           msg: String) : IllegalStateException("At $lineNumber:$columnNumber $msg")
